...
/**
 * Class Mercedes create car mercedes with param: body, engine, transmission, color, sound, price.
...
public class Mercedes implements Car {
     ...
     */
    @Autowired
    Mercedes(@Qualifier("coupe") Body body, @Qualifier("inline") Engine engine, @Qualifier("automatic") Transmission transmission) {
        this.body = body;
        this.engine = engine;
